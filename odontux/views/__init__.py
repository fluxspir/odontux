...
from administration import (
                 ...
                 update_patient_mail, add_patient_mail
                 )
...
from md import (
                ...
                add_md,
                update_md,
                update_md_address, add_md_address,
                update_md_phone, add_md_phone, delete_md_phone,
                update_md_mail, add_md_mail
                )
from users import (
                list_users,
                add_user,
                update_user,
                update_user_address, add_user_address,
                update_user_phone, add_user_phone, delete_user_phone,
                update_user_mail, add_user_mail
                )
