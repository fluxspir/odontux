...
ANATOMIC_LOCATION = {
            ...
            SUPERIORLIP: ( _("superior lip"), str(SUPERIORLIP), "softtissues", 
                                                        "SuperiorLipEvent"),
            INFERIORLIP: ( _("inferior lip"), str(INFERIORLIP),"softtissues", 
                                                        "InferiorLipEvent"),
            LEFTCHEEK: ( _("left cheek"), str(LEFTCHEEK),"softtissues", 
                                                        "LeftCheekEvent"),
            RIGHTCHEEK: ( _("right cheek"), str(RIGHTCHEEK),"softtissues", 
                                                        "RightCheekEvent"),
            HARDPALATE: ( _("hard palate"), str(HARDPALATE),"softtissues", 
                                                        "HardPalateEvent"),
            SOFTPALATE: ( _("soft palate"), str(SOFTPALATE),"softtissues", 
                                                        "SoftPalateEvent"),
            TONGUE: ( _("tongue"), str(TONGUE), "softtissues", "TongueEvent"),
            MOUTHBASE: ( _("mouth base"), str(MOUTHBASE),"softtissues", 
                                                            "MouthBaseEvent"),
            UVULA: ( _("palatine uvula"), str(UVULA), "softtissues", 
                                                            "UvulaEvent"),
        }
